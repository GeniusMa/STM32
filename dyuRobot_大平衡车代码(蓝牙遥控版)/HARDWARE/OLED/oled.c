...
void OLED_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB|RCC_APB2Periph_AFIO, ENABLE);	 //Ê¹ÄÜB¶Ë¿ÚÊ±ÖÓ
...
///¿ª»úÏÔÊ¾ÐèÒªÏÔÊ¾µÄ£¬Ö»ÐèÒªÏÔÊ¾Ò»´Î¼´¿É¡£¼õÉÙCPUµÄÔËËã¡£/////////////////
...
void oled_show(void)
{
		...
		OLED_Float(2,48,Voltage,2);						//ÏÔÊ¾µçÑ¹
		OLED_Num2(4,6,Encoder_Right);					//ÏÔÊ¾ÓÒ±ßµç»úµÄ±àÂëÆ÷Öµ
		OLED_Num2(14,6,Encoder_Left);					//ÏÔÊ¾×ó±ßµç»úµÄ±àÂëÆ÷Öµ
		OLED_Float(4,70,UltrasonicWave_Distance,3);						//ÏÔÊ¾³¬Éù²¨µÄ¾àÀë
}
